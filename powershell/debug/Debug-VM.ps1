...
$resourceParams = @{
    ResourceGroupName = $inventoryVars.debug_values.vm.resourceGroupName
...
try {
    ...
    Set-MESFAzVM -ResourceGroupName $azResourceGroup.ResourceGroupName `
                 -Location $azResourceGroup.Location `
                 -VirtualMachine $inventoryVars.debug_values.vm.virtual_machine
