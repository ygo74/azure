...
$aksPublicIpName      = "myAKSPublicIP"
$aksPublicIpDnsLabel  = "testygo"
$acrName              = "acrdemobootstrap"
...
$publicIp = $(az network public-ip show -g $aksNodeGroup -n $aksPublicIpName -o tsv --query "ipAddress")
$publicIp
